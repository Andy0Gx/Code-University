...
void DeleteGame (Game *&);									 //Eliminar un juego
	...
	do {
		...
		switch (option) {
			...
			case 4:		//* --> DELETE A GAME
				...
				cout << "\n\t\tEl juego que se va a eliminar es el ultimo de la lista.\n ";
				cout << "\n\t\tEsta seguro que desea eliminar el juego? (Y/N): "; cin >> answer;
				system("cls");
				if (answer == 'Y' or answer == 'y') {
					cout << "\n\t\t-----The Game Library-----\n";
					DeleteGame(GameLibrary);
					cout << "\n\t\t--------------------------\n";
					cout << "\n\t\t" << system("pause");
...
// agregar los juegos al principio de la lista
...
//Eliminar el ultimo juego de la biblioteca

void DeleteGame (Game *& GameLibrary) {
	Game *Position = new Game();
